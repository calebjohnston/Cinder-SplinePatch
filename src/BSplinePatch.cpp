...
void BSplinePatch::getFrame(float u, float v, vec3& position,
							vec3& tangent0, vec3& tangent1, vec3& normal) const
{
	position = P(u, v);
	tangent0 = PU(u, v);
	tangent1 = PV(u, v);
...
void BSplinePatch::computePrincipalCurvatureInfo(float u, float v,
												 float& curve0, float& curve1,
												 vec3& direction0, vec3& direction1)
{
	//======================================================================
